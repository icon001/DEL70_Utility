...
type
  ...
  private
    ...
    procedure LoadAuthCompanyCode(cmb_Box:TComboBox;TempList:TStringList;bAll:Boolean = True);
    procedure LoadAuthCompanyCodeAll(cmb_Box:TComboBox;TempList:TStringList;bAll:Boolean = True);
  public
    { Public declarations }
  end;
...
begin
  ...
  LoadAuthCompanyCodeAll(cmb_AuthCompanyCode,AuthCompanyCodeList,False);
